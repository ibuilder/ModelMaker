...
- 🧊 **BIM platform** — stream + author IFC in the browser (That Open Fragments), QA, IDS, BCF, 2D drawings; **layer & align multiple models** (Navisworks-style) with **federated cross-discipline clash**; also opens **meshes & point clouds** (OBJ/STL/PLY/glTF · PCD/XYZ/**LAS/LAZ**) as reference overlays, with **QR sharing**
